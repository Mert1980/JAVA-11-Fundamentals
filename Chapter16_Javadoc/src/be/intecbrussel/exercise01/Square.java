 ...
 * @author Mert Demirok
 * @version 1.0
 * @see be.intecbrussel.exercise01.Rectangle
 */
public class Square extends Rectangle {
     ...
     * @throws be.intecbrussel.exercise01.NegativeSizeException The side is negative.
     */
     ...
     * {@link be.intecbrussel.exercise01.Square#setSide(int)}.
     * @return The side of the square.
     * @see be.intecbrussel.exercise01.Square#setSide(int)
     */
    public int getSide(){
        return getHeight();
    }
